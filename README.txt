This repository includes R code for reproducing Table 3 to 5, and Figure 1 in the article "Sample size calculation in hierarchical 2x2 factorial trials with unequal cluster sizes" (under review), and Web Table 1-27 in its supplementary material.
